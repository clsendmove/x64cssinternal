...
enum class e_text_align : unsigned char {
    TEXT_LEFT,
    TEXT_CENTER,
    TEXT_RIGHT
};
...
namespace fonts {
    ...
    //inline ImFont* FONT_TAHOMA;
    //inline ImFont* FONT_VERDANA;
} // namespace fonts


namespace u {
    inline c_render_threaded draw;
    inline c_render draw_add;
    inline c_drawsystem drawsystem;
}