...
inline bool CBaseHandle::operator ==(const i_handle_entity* pEnt) const
{
	return Get() == pEnt;
}
...
inline bool CBaseHandle::operator <(const i_handle_entity* pEntity) const
{
...
{
	CBaseHandle::Set(reinterpret_cast<const i_handle_entity*>(pVal));
}
